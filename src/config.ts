...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/tupian.jpeg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Origin",
	...
	links: [
		{
			...
			url: "https://qm.qq.com/cgi-bin/qm/qr?k=LU4YW-dvAfSppoun4xFG4cvTfk3r0csE",
		},
